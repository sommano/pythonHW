...
show_urls = input("Show URLd as well? y/n:")
filter = input("Enter a word or term you wnt to filter out: ")
...
while 1:
    ...
    myfeed = feedparser.parse("https://www.reddit.com/r/" + subreddit + "/.rss")
